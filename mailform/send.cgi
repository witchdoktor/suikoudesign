...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'info@suikoudesign.com';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://suikoudesign.com/thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = '水交デザインオフィス メールフォームより';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '水交デザインオフィス：お問い合わせありがとうございます';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
この度はお問い合わせいただき、まことにありがとうございました。
ご送信の内容を確認させていただきます。
